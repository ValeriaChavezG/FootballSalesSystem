...
<body>
    ...
    <section class="FormularioLogin">
        <div class="login-container">
            <!-- Parte izquierda: Formulario de inicio de sesión -->
            <div class="login-form">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" name="email" class="form-input" value="{{ old('email') }}" required autofocus autocomplete="email">
                    </div>
                    <div class="form-group">
            ...
            <!-- Parte derecha: Animación de GIFs -->
